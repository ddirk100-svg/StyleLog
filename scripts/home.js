...
async function renderDayList(logs) {
    ...
    const lastYearLabel = container.querySelector('.year-label-day-view:last-of-type');
    const lastMonthLabel = container.querySelector('.month-label-day-view:last-of-type');
...
function handleInfiniteScroll() {
    ...
    // 스크롤이 바닥에서 200px 이내로 도달하면 추가 로드
    ...
    if (distanceFromBottom < 200 && !isLoading && hasMoreData) {
