 ...
 * Vercel: RESEND_API_KEY, RESEND_FROM 필수. 알파 Host면 RESEND_FROM_ALPHA(표시명만 다르게: StyleLog (Alpha) <noreply@...>).
 */
...
async function sendInquiryFirstReplyEmail(opts) {
  ...
  return sendResendEmail({ to, subject, text, html, host: opts && opts.host });
}
